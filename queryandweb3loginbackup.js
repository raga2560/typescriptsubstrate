...
const randomessage = (Math.random() + 1).toString(36).substring(7);

let signature = signmessage(randomessage, alice);

let isValid = verifymessage(randomessage, signature, alice);
