...
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var provider, api, keyring, alice, transfer, hash, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    provider = new WsProvider('wss://indra-testnet.selendra.org');
                ...
                case 1:
                    ...
                    transfer = api.tx.balances.transfer(BOB, 12);
                    _a.label = 2;
                case 2:
                    _a.trys.push([2, 4, , 5]);
                ...
                case 4:
                    err_1 = _a.sent();
                    console.log('Transfer send error ', err_1);
                    return [3 /*break*/, 5];
